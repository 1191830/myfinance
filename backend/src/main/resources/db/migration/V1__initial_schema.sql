...
CREATE INDEX idx_recurring_transaction_active ON recurring_transactions(active);
CREATE INDEX idx_recurring_transaction_start_date ON recurring_transactions(start_date);
